...
export const IF_ACTOR_ON_SCREEN = "IF_ACTOR_ON_SCREEN";
export const SCRIPT_RETURN = "SCRIPT_RETURN";
export const ACTOR_FACE_ACTOR = "ACTOR_FACE_ACTOR";
export const ACTOR_CHASE_ACTOR = "ACTOR_CHASE_ACTOR";
export const ACTOR_FOLLOW_ACTOR = "ACTOR_FOLLOW_ACTOR";
