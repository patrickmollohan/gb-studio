...
export const ACTOR_FACE_PLAYER = "ACTOR_FACE_PLAYER";
export const ACTOR_FACE_PLAYER_HORIZONTAL = "ACTOR_FACE_PLAYER_HORIZONTAL";
export const ACTOR_FACE_PLAYER_VERTICAL = "ACTOR_FACE_PLAYER_VERTICAL";
